...
return [
    ...
    */
    ...
    'defaults' => [
        'guard' => env('AUTH_GUARD', 'pelanggan'), // Set default guard ke 'pelanggan'
        'passwords' => env('AUTH_PASSWORD_BROKER', 'pelanggan'), // Set default password broker ke 'pelanggan'
    ],
    ...
    */
    ...
    'guards' => [
        ...
        'pelanggan' => [ // Tambahkan guard untuk Pelanggan
            'driver' => 'session',
            'provider' => 'pelanggan',
        ],
