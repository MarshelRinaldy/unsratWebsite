            ...
            <div class="col-md-8 offset-md-2">
                <form action="{{ route('admin.settings.update') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="contact" name="contact" value="{{ $settings->contact ?? '' }}" required>
                    </div>
                    <div class="mb-3">
                        <label for="about_us" class="form-label">Konten Tentang Kami</label>
                        <textarea class="form-control" id="about_us" name="about_us" rows="5" required>{{ $settings->about_us ?? '' }}</textarea>
                    </div>
